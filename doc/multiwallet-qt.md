...
In order to support loading of multiple wallets in bullishcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bullishcoin.cpp.
...
Changes to bullishcoin.cpp
----------------------
bullishcoin.cpp is the entry point into bullishcoin-qt, and as such, will require some minor modifications to provide hooks for
