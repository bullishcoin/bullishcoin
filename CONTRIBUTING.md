Contributing to Bullishcoin Core
============================

The Bullishcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bullishcoin Core project, and is not to be
confused with overall Bullishcoin Network Protocol consensus changes.

Whether a pull request is merged into Bullishcoin Core rests with the project merge
...
Patches that change Bullishcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bullishcoin consensus, it must have been
...
The project leader is the release manager for each Bullishcoin Core release.
