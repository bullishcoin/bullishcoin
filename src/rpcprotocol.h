...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Bullishcoin is not connected
    ...
    RPC_WALLET_PASSBULLISHCOINASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
