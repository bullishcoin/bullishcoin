                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bullishcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bullishcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bullishcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bullishcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bullishcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bullishcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bullishcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bullishcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bullishcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bullishcoin Core help message to get a list with possible Bullishcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bullishcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bullishcoin network", "", count));
}
...
{
    QString strTitle = tr("Bullishcoin Core"); // default title
...
/** Creates context menu, its actions, and bullishcoins up all the relevant signals for mouse events. */
