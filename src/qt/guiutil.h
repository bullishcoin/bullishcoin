...
/** Utility functions used by the Bullishcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Bullishcoin addresses in monospace font
...
// Parse "bullishcoin:" URI into recipient object, return true on successful parsing
