...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bullishcoin Core"),
     ...
     * override -datadir in the bullishcoin.conf file in the default data directory
     * (to be consistent with bullishcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
