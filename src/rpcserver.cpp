...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bullishcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Bullishcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bullishcoin features */
        {"bullishcoin", "masternode", &masternode, true, true, false},
        {"bullishcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bullishcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bullishcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bullishcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bullishcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bullishcoin", "startmasternode", &startmasternode, true, true, false},
        {"bullishcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bullishcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bullishcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bullishcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bullishcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bullishcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bullishcoin", "mnbudget", &mnbudget, true, true, false},
        {"bullishcoin", "preparebudget", &preparebudget, true, true, false},
        {"bullishcoin", "submitbudget", &submitbudget, true, true, false},
        {"bullishcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bullishcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bullishcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bullishcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bullishcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bullishcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bullishcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bullishcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bullishcoin", "mnsync", &mnsync, true, true, false},
        {"bullishcoin", "spork", &spork, true, true, false},
        {"bullishcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bullishcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bullishcoind, or the -server option to bullishcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bullishcoin-cli " + methodname + " " + args + "\n";
}
