...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bullishcoin Core bullishcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bullishcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bullishcoin transaction") + "\n" +
                               "  bullishcoin-tx [options] -create [commands]   " + _("Create hex-encoded bullishcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bullishcoin transaction
